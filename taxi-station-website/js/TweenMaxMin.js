...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
          ...
          (_.render = function (t, e, i) {
            ...
            if (t >= f)
              ...
              if (
                ...
                (this._active = !1),
                  this._timeline.autoRemoveChildren && this._reversed
                    ? ((u = a = !0), (_ = "onReverseComplete"))
                    : y >= 0 && this._first && (u = !0),
                  (this._rawPrevTime = t);
              else {
                if (
                  ((this._rawPrevTime =
                    c || !e || t || this._rawPrevTime === t ? t : r),
                  0 === t && a)
                )
                  for (s = this._first; s && 0 === s._startTime; )
            ...
            if (this._cycle !== w && !this._locked) {
              ...
              if (
                ...
                b && ((m = x ? c + 1e-4 : -1e-4), this.render(m, !0, !1)),
                (this._locked = !1),
                this._paused && !T)
              )
                return;
          ...
          K = function (t, e) {
            ...
            if ((e = e || Z(t, null)))
              if ((i = e.length))
                for (; --i > -1; )
                  (r = e[i]),
                    (-1 === r.indexOf("-transform") || be === r) &&
                      (n[r.replace(k, A)] = e.getPropertyValue(r));
              else
                for (i in e)
                  ...
                  w && !j && 0 === m[3]
                    ...
                    : (j || (w = !1),
                      a
                        ...
                        .appendXtra("", c[1], m[1] - c[1], ",", !0)
                        .appendXtra("", c[2], m[2] - c[2], w ? "," : S, !0),
                      w &&
                        ((c = 4 > c.length ? 1 : c[3]),
                        a.appendXtra(
                          "",
        ...
        var Te,
            ...
            if (
              ...
              if (16 === h.length) {
                ...
                d.zOrigin &&
                  ...
                  (d.z = j),
                  d.svg &&
                    ((d.x -= d.xOrigin - (d.xOrigin * R - d.yOrigin * M)),
                ...
                (d.x = h[4] || 0),
                  ...
                  Se &&
                    ...
                    (d.scaleZ = 1)),
                  d.svg &&
                    ((d.x -= d.xOrigin - (d.xOrigin * G - d.yOrigin * W)),
          ...
          Ie = (U.set3DTransformRatio = function (t) {
            ...
            (l = 1),
              ...
              1 !== k && ((e *= k), (r *= k), (o *= k), (_ *= k)),
              (c || b.svg) &&
                (c && ((O += s * -c), (C += a * -c), (D += l * -c + c)),
                b.svg &&
                  ((O += b.xOrigin - (b.xOrigin * e + b.yOrigin * i)),
                  (C += b.yOrigin - (b.xOrigin * r + b.yOrigin * n))),
                m > O && O > -m && (O = x),
                m > C && C > -m && (C = x),
                m > D && D > -m && (D = 0)),
              (T =
          ...
          Fe = (U.set2DTransformRatio = function (t) {
            ...
            return !(
              ...
              f.z ||
              f.force3D === !0 ||
              ("auto" === f.force3D && 1 !== t && 0 !== t)
            ) ||
              (f.svg && Te) ||
              !Se
              ? ((r = f.scaleX),
                (n = f.scaleY),
                f.rotation || f.skewX || f.svg
                  ? ((e = f.rotation * z),
                    (i = f.skewX * z),
                    (s = 1e5),
                    (a = Math.cos(e) * r),
                    ...
                    i &&
                      ...
                      (l *= p)),
                    f.svg &&
                      ((d += f.xOrigin - (f.xOrigin * a + f.yOrigin * h)),
                      (g += f.yOrigin - (f.xOrigin * o + f.yOrigin * l)),
                      (u = 1e-6),
                      u > d && d > -u && (d = 0),
                      u > g && g > -u && (g = 0)),
                    (_ =
            ...
            "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
            {
              parser: function (t, e, i, s, n, o, h) {
                ...
                return (
                  ...
                  c &&
                    (s._transformType =
                      (d.svg && Te) || (!f && 3 !== this._transformType)
                        ? 2
                        : 3),
                  n
                );
          ...
          parser: function (t, e, i, s, n, a) {
            ...
            return (
              ...
              j
                ...
                : ((n = new ce(h, "opacity", 100 * o, 100 * (e - o), n)),
                  (n.xn1 = l ? 1 : 0),
                  (h.zoom = 1),
                  (n.type = 2),
          ...
          (l._onInitTween = function (t, e, o) {
            ...
            if (
              ...
              "string" == typeof e &&
                ...
                (w.cssText = m + ";" + e),
                (h = J(t, h, K(t)).difs),
                !j && x.test(e) && (h.opacity = parseFloat(RegExp.$1)),
                (e = h),
                (w.cssText = m)),
            ...
            if (i) {
              for (; l; ) {
                ...
                (l._prev = f ? f._prev : d) ? (l._prev._next = l) : (m = l),
                  (l._next = f) ? (f._prev = l) : (d = l),
                  (l = g);
              }
              this._firstPT = m;
            }
                    ...
                    (d && P.test(f))
                      ? (d ||
                          ...
                          (f =
                            ...
                            f.join(",") +
                            ")")),
                        (i = me(v, a, p, f, !0, "transparent", i, 0, n)))
  ...
  (function (t, e) {
    ...
    if (!i.TweenLite) {
      ...
      var I = [],
        F = {},
        E = (D._internals = { isArray: f, isSelector: M, lazyTweens: I }),
        N = (D._plugins = {}),
        L = (E.tweenLookup = {}),
        X = 0,
        U = (E.reservedProps = {
